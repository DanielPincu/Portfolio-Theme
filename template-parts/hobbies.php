...
<div class="crd-blue crd-red border-2 border-blue-300 dark:border-red-300 mx-5 my-5 flex flex-col bg-blue-200 dark:bg-red-500 rounded-full items-center h-16 justify-center move-in">
  <h1 class="text-xl font-bold px-4 dark:text-slate-200"><?php the_title();?></h1>
